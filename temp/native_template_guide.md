...
3. 해당 layout 에 필요한 요소들을 세팅합니다. (drawable, font, style)
4. 사용할 네이티브 템플릿의 최상단 레이아웃 id 를 통해 뷰 객체를 가져옵니다.
```java
...
4. 네이티브 광고를 적용합니다.
   ...
   [엑셀비드 SDK 네이티브 광고 적용 가이드](https://github.com/onnuridmc/ExelBid-Android-SDK#%EB%84%A4%EC%9D%B4%ED%8B%B0%EB%B8%8C)와 아래 예시 코드를 참고하여 광고를 적용합니다.
